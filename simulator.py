...
class Simulator(object):
    ...
    ''' function init: constructor for cuneyds simulator
        @param width (int): width (in pixels) for the simulator screen
        @param height (int): height (in pixels) for the simulator screen
